...
exports.default = _default;
        ...
        var $d81f3b = exports.default || module.exports;
      
      if (typeof $d81f3b === 'function') {
        $d81f3b = $d81f3b.options;
      }
    
        /* template */
        Object.assign($d81f3b, (function () {
          var render = function() {
  var _vm = this
...
},{}],"unable-to-connect.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    ...
    async runCommand(args) {
      ...
      if (result.pid) {
        this.checkIsAbleToConnect(); //rpc('switchTab', {url: this.url});
      }
    },
...
exports.default = _default;
        var $279f80 = exports.default || module.exports;
      
      if (typeof $279f80 === 'function') {
        $279f80 = $279f80.options;
      }
    
        /* template */
        Object.assign($279f80, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "container" }, [
    _c("div", { staticClass: "centered" }, [
      _vm.ableToConnect
        ? _c("div", [
            _c("h1", [_vm._v("Able to connect :-D")]),
            _vm._v(" "),
            _c("p", [_vm._v("There is a service running!")]),
            _vm._v(" "),
            _c("a", { attrs: { href: _vm.url, target: "_self" } }, [
              _vm._v("Open " + _vm._s(_vm.url) + " now.")
            ])
          ])
        : _vm._e(),
      _vm._v(" "),
      !_vm.ableToConnect
        ? _c("div", [
            _c("div", { staticClass: "header" }, [
              _c("h1", [_vm._v("Unable to connect")]),
              _vm._v(" "),
              _c("p", [
                _vm._v(
            ...
            _vm._v(" "),
            _vm.solutions.length > 0 && !_vm.addOtherSolution
              ? _c("div", [
                  _c("h3", [_vm._v("Solutions:")]),
                  _vm._v(" "),
                  _c(
                    "ul",
                    _vm._l(_vm.solutions, function(s) {
                      return _c(
                        "li",
                        {
                          attrs: {
                            title: _vm.canExecuteCommand
                              ? "Click to execute"
                        ...
                        [
                          _vm._v("\n                        Run "),
                          _c("code", [_vm._v(_vm._s(s.command))]),
                          _vm._v(" in "),
                          _c("code", [_vm._v("~/" + _vm._s(s.directory))])
                        ]
                      )
                    }),
                    0
                  ...
                  _c(
                    "a",
                    {
                      ...
                      on: {
                        click: function($event) {
                          _vm.addOtherSolution = true
                        }
                      }
                    },
                    [_vm._v("Add another solution")]
                  )
                ])
              : _vm._e(),
            _vm._v(" "),
            _vm.solutions.length == 0 || _vm.addOtherSolution
              ? _c("div", [
                    ...
                    ? _c("div", [
                        _c(
                          "a",
                          {
                            ...
                            on: {
                              click: function($event) {
                                _vm.addOtherSolution = false
                              }
                            }
                          },
                          [_vm._v("Cancel and view existing solutions")]
                        )
                      ])
                    : _vm._e(),
                  _vm._v("\n\n                Directory:\n                "),
                  _c("input", {
                    ...
                    on: {
                      keydown: function($event) {
                        ...
                        return _vm.showCompletions()
                      },
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.directory = $event.target.value
                      }
                    }
                  }),
                  _vm._v(" "),
                  _vm.completions
                    ? _c(
                        "div",
                        { staticClass: "completions" },
                        _vm._l(_vm.completions, function(c) {
                          return _c(
                            "span",
                            {
                              on: {
                  ...
                  _c("input", {
                    ...
                    staticClass: "form-control",
                    attrs: { placeholder: "Enter command" },
                  ...
                  _c("div", { staticClass: "mt-3" }, [
                    ...
                    _c(
                      ...
                      {
                        attrs: {
                          disabled: !_vm.canExecuteCommand || !_vm.command
                        },
                        on: {
                          click: function($event) {
      ...
      _c("div", { staticClass: "note" }, [
        _vm.canExecuteCommand
          ? _c("span", [_vm._v("Backend process is running.")])
          : _vm._e(),
        _vm._v(" "),
        !_vm.canExecuteCommand
          ? _c(
...
render._withStripped = true
          ...
          return {
            ...
            staticRenderFns: staticRenderFns,
            _compiled: true,
            _scopeId: "data-v-279f80",
            functional: undefined
          };
        })());
      
},{"./browser-rpc":"browser-rpc.js"}],"../node_modules/browser-extension-tools/browser-rpc.js":[function(require,module,exports) {
...
function getServer() {
    ...
    return function register(fn, callback) {
        ...
        console.log("Register services", services);
...
},{}],"settings.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $dabeb9 = exports.default || module.exports;
      
      if (typeof $dabeb9 === 'function') {
        $dabeb9 = $dabeb9.options;
      }
    
        /* template */
        Object.assign($dabeb9, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("div", { staticClass: "container" }, [
      _c("div", { staticClass: "col-sm-12" }, [
        _c("h1", [_vm._v("Flextension setup")]),
        _vm._v(" "),
        _c("p", [
          _vm._v(
              ...
              _c(
                ...
                [
                  _c("div", { staticClass: "form-group" }, [
                    ...
                    _c("small", [
                      _vm._v(
                        "Start flextension on your terminal. It will display the port it's listening to"
                      )
                    ])
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "form-group" }, [
                    ...
                    _c("small", [
                      _vm._v(
                        "Flextension will also display a security token, copy-paste it here."
                      )
                    ])
                  ]),
                  _vm._v(" "),
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "container" }, [
      _c("div", { staticClass: "col-sm-12" }, [
        _c("h1", [_vm._v("General Localhost settings")]),
        _vm._v(" "),
        _c("div", [
          _c("label", [
...
render._withStripped = true
          ...
          return {
            ...
            staticRenderFns: staticRenderFns,
            _compiled: true,
            _scopeId: "data-v-dabeb9",
            functional: undefined
          };
        })());
      
},{"browser-extension-tools/browser-rpc":"../node_modules/browser-extension-tools/browser-rpc.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
var _unableToConnect = _interopRequireDefault(require("./unable-to-connect.vue"));

var _settings = _interopRequireDefault(require("./settings.vue"));
...
var routes = [{
  ...
  "component": _unableToConnect.default
}, {
  "path": "/settings",
...
},{"vue/dist/vue.common":"../node_modules/vue/dist/vue.common.js","vue-router":"../node_modules/vue-router/dist/vue-router.esm.js","bootstrap/dist/css/bootstrap.css":"../node_modules/bootstrap/dist/css/bootstrap.css","./app.vue":"app.vue","./unable-to-connect.vue":"unable-to-connect.vue","./settings.vue":"settings.vue"}]},{},["app.js"], null)